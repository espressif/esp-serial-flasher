...
{
    size_t removeEncription = target == ESP32S2_CHIP ? 0 : sizeof(uint32_t);

    begin_command_t begin_cmd = {
        .common = {
            .direction = WRITE_DIRECTION,
            .command = FLASH_BEGIN,
            .size = CMD_SIZE(begin_cmd) - removeEncription,
            .checksum = 0
        },
    ...
    return send_cmd(&begin_cmd.common, sizeof(begin_cmd) - removeEncription, NULL);
}
