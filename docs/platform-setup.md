...
- **CMake 3.5 or later** - Build system generator
- **Platform-specific toolchain** - See individual platform sections below

## ESP-IDF Support

**Testing Status**: Regularly tested with ESP-IDF v4.3 and later versions.

### Prerequisites

- **ESP-IDF v4.3+** - ESP-IDF development framework
...
- **STM32 HAL libraries** - For your specific target chip family
...
- **pigpio library** - For GPIO control and hardware interfacing
