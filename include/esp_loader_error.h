...
typedef enum {
    ...
    ESP_LOADER_ERROR_EFUSE_BURN_FAILED /*!< eFuse programming was attempted but the chip
                                            reported an error or failed read-back
                                            verification; fuses may be partially burned */
} esp_loader_error_t;
